    ...
    <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        ...
        {/* <!-- <form action="" id="signupform"> --> */}
            ...
            <div className="mb-6">
                ...
                <input type="password" id="confirm-password" name="confirm-password" className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                required
